...
#define PACKAGE_BUGREPORT "bogofilter-bugs@sbellon.de"

/* Define to the full name of this package. */
#define PACKAGE_NAME "bogofilter"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "bogofilter 0.15.1-sb1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bogofilter-0.15.1-sb1.tar.gz"

/* Define to the version of this package. */
#define PACKAGE_VERSION "0.15.1-sb1"
